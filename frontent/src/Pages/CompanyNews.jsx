  ...
  return (
    <div className="container mx-auto mt-8">
      ...
      <div className="col-12 text-center standard_page_content">
        <div className="Blog_blog_header_title__u2hU5"><h1 className="category_title"> Company News</h1><p className="Blog_blog_header_sub_title__B40oZ">Here you'll find all of our latest news and views - including top tips, handy guides and fun content for our fellow book lovers!</p></div>
      </div>
