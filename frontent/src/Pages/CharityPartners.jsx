  ...
  return (
    <div className="container mx-auto mt-8">
      ...
      <div className="col-12 text-center standard_page_content">
        <div className="Blog_blog_header_title__u2hU5"><h1 className="category_title">Charity Partners</h1><p className="Blog_blog_header_sub_title__B40oZ">Here you'll find all of our latest news and views - including top tips, handy guides and fun content for our fellow book lovers!</p></div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {blogs.map(blog => (
          <Link to={`/blogdetails/${blog._id}`} key={blog._id}>
